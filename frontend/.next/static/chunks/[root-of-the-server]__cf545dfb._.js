...
"[project]/store/slices/authReducer.tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authReducer$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/slices/authReducer.tsx [client] (ecmascript)");
;
...
function AuthComponent() {
    ...
    const { loading, error, isAuthenticated, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "AuthComponent.useSelector": (state)=>state.auth
    }["AuthComponent.useSelector"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authReducer$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["authStart"])());
        setMessage('');
        try {
            ...
            const response = await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:8080/")).concat(endpoint), {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                if (isLogin && data.token) {
                    ...
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authReducer$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["authSuccess"])({
                        user: data.user,
                        token: data.token
                    }));
                ...
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authReducer$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["authFailure"])(data.msg || 'An error occurred'));
            }
        } catch (error) {
            setMessage('Network error. Please try again.');
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authReducer$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["authFailure"])('Network error. Please try again.'));
...
_s(AuthComponent, "e9CQO2F03I2/Mlb4oMMXWK/NBkU=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/login.tsx [client] (ecmascript)\" } [client] (ecmascript)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf545dfb._.js.map