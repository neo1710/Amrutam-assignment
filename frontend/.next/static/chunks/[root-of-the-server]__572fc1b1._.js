...
function AuthComponent() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("/api/users".concat(endpoint), {
                method: 'POST',
                headers: {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "p-4 rounded-lg text-sm ".concat(message.includes('successfully') || message.includes('Success') ? 'bg-green-50 text-green-800 border border-green-200' : 'bg-red-50 text-red-800 border border-red-200'),
                                    children: message
                                }, void 0, false, {
                                    fileName: "[project]/pages/login.tsx",
                                    lineNumber: 253,
...
_s(AuthComponent, "CRT2dTcLQ+mNDIovpDUC1+TMYqE=");
_c = AuthComponent;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__572fc1b1._.js.map